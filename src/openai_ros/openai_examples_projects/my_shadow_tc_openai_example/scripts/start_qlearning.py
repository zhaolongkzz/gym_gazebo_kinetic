...
if __name__ == '__main__':
    ...
    Alpha = rospy.get_param("/shadow_tc/alpha")
    Epsilon = rospy.get_param("/shadow_tc/epsilon")
    Gamma = rospy.get_param("/shadow_tc/gamma")
    epsilon_discount = rospy.get_param("/shadow_tc/epsilon_discount")
    nepisodes = rospy.get_param("/shadow_tc/nepisodes")
    nsteps = rospy.get_param("/shadow_tc/nsteps")
