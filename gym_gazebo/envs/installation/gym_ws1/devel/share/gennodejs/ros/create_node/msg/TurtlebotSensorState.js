...
class TurtlebotSensorState {
  constructor(initObj={}) {
    if (initObj === null) {
      ...
      this.user_digital_outputs = null;
      ...
      if (initObj.hasOwnProperty('user_digital_outputs')) {
        this.user_digital_outputs = initObj.user_digital_outputs
      }
      else {
  ...
  static serialize(obj, buffer, bufferOffset) {
    ...
    bufferOffset = _serializer.uint8(obj.user_digital_outputs, buffer, bufferOffset);
    ...
    bufferOffset = _serializer.int32(obj.requested_velocity, buffer, bufferOffset);
    // Serialize message field [requested_radius]
    bufferOffset = _serializer.int32(obj.requested_radius, buffer, bufferOffset);
    // Serialize message field [requested_right_velocity]
    bufferOffset = _serializer.int32(obj.requested_right_velocity, buffer, bufferOffset);
    // Serialize message field [requested_left_velocity]
    bufferOffset = _serializer.int32(obj.requested_left_velocity, buffer, bufferOffset);
    return bufferOffset;
  }
  ...
  static deserialize(buffer, bufferOffset=[0]) {
    ...
    let len;
    let data = new TurtlebotSensorState(null);
    ...
    data.user_digital_outputs = _deserializer.uint8(buffer, bufferOffset);
    ...
    data.requested_velocity = _deserializer.int32(buffer, bufferOffset);
    // Deserialize message field [requested_radius]
    data.requested_radius = _deserializer.int32(buffer, bufferOffset);
    // Deserialize message field [requested_right_velocity]
    data.requested_right_velocity = _deserializer.int32(buffer, bufferOffset);
    // Deserialize message field [requested_left_velocity]
    data.requested_left_velocity = _deserializer.int32(buffer, bufferOffset);
    return data;
  }
  ...
  static Resolve(msg) {
    ...
    const resolved = new TurtlebotSensorState(null);
    ...
    if (msg.user_digital_outputs !== undefined) {
      resolved.user_digital_outputs = msg.user_digital_outputs;
    }
    else {
      resolved.user_digital_outputs = 0
    }
