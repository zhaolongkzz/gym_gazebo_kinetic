...
cp -r ../assets/urdf/kobuki_cnn_urdf/kobuki_urdf/urdf/ gym_ws/src/kobuki/kobuki_description
cp -r ../assets/urdf/kobuki_cnn_urdf/turtlebot_urdf/urdf/ gym_ws/src/turtlebot/turtlebot_description

#copy laser mesh file
cp ../assets/meshes/lidar_lite_v2_withRay.dae gym_ws/src/kobuki/kobuki_description/meshes

echo "finish turtle_cnn_setup!"
