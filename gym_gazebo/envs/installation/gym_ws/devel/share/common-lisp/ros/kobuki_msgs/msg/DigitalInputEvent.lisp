...
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql '<DigitalInputEvent>)))
  ...
  (cl:format cl:nil "# This message is generated whenever the value of one or more digital input pins changes.~%~%# Array of values; indices represent pins 0-3 respectively.~%bool[4] values~%~%~%"))
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql 'DigitalInputEvent)))
  "Returns full string definition for message of type 'DigitalInputEvent"
  (cl:format cl:nil "# This message is generated whenever the value of one or more digital input pins changes.~%~%# Array of values; indices represent pins 0-3 respectively.~%bool[4] values~%~%~%"))
